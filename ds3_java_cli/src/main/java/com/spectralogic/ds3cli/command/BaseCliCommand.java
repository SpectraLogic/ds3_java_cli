...
public abstract class BaseCliCommand<T extends Result> implements CliCommand<T> {
    ...
    public BaseCliCommand withProvider(final Ds3Provider ds3Provider, final FileSystemProvider fileSystemProvider) {
        this.ds3Provider = ds3Provider;
        this.fileSystemProvider = fileSystemProvider;
        return this;
    }

    public BaseCliCommand(final Ds3Provider ds3Provider, final FileSystemProvider fileSystemProvider) {
        this.ds3Provider = ds3Provider;
        this.fileSystemProvider = fileSystemProvider;
    }
