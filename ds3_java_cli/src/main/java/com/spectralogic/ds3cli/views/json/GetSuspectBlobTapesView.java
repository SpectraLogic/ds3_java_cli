...
public class GetSuspectBlobTapesView implements View<SuspectBlobTapesResult> {
    @Override
    public String render(final SuspectBlobTapesResult obj) throws JsonProcessingException {
